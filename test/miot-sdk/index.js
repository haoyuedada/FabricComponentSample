...
// @native begin
if (Host.ui) {
  // inject the navigate method from Package to Host.ui
  Host.ui.constructor.prototype.packageNavigate = (name, params = {}, push) => {
    // for cycle depedence fix, use arrow func to avoid navigate context problems
    Package.navigate(name, params, push);
  };
  Host.ui.constructor.prototype.packageExit = () => {
    Package.exit();
  };
  PackageRoot.prototype.onClassVariablesReseted = () => {
    ReuseHelper.resetClassVariables();
  };
}
// @native end
