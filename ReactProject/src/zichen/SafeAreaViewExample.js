    ...
    <ScrollView>
      <View style={{ flex: 1, alignItems: 'center' }}>
        ...
        <View style={{ marginBottom: 30, borderWidth: 1, padding: 10, width: 320 }}>
          ...
          <Text style={{ marginBottom: 5 }}>属性值：accessibilityLanguage='zh'</Text>
          <Text style={{ marginBottom: 5 }}>预期效果:使用中文的辅助功能打开时，点击这个视图，可以听到 "爱" 的声音提示</Text>
...
export default ({
  title: 'SafeAreaView',
  name: 'SafeAreaViewAccessible',
  description:
    'Accessiblity about SafeAreaView',
