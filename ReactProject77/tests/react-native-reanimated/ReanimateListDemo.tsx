                ...
                <SafeAreaView>
                    <NavigationContainer>
                        <PortalProvider>
                            ...
                            <Page name="ReducedMotionConfigExample">
                                <ReducedMotionConfigExample/>
                            </Page>
                            <Page name="LayoutAnimationConfigExample">
                                <LayoutAnimationConfigExample />
                            </Page>
                            <Page name="UseComposedEventHandlerExample">
                                <UseComposedEventHandlerExample />
                            </Page>
                            <Page name="ItemLayoutAnimationExample">
                                <ItemLayoutAnimationExample />
                            </Page>
                            <Page name="LayoutTeansitionExample">
                                <LayoutTeansitionExample />
                            </Page>
                            <Page name="UseSharedValueExample">
                                <UseSharedValueExample />
                            </Page>
                            <Page name="WithSpringClampExample">
